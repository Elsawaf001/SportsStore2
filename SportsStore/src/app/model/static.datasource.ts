...
export class StaticDataSource {
  private products: Product[] = [
    ...
    new Product(1, 'Product 2', 'Categoey 1', 'Descreption 2', 400),
    new Product(1, 'Product 3', 'Categoey 3', 'Descreption 3', 100),
    new Product(1, 'Product 4', 'Categoey 3', 'Descreption 4', 2500),
    new Product(1, 'Product 5', 'Categoey 5', 'Descreption 5', 500),
    new Product(1, 'Product 6', 'Categoey 1', 'Descreption 6', 800),
    ...
    new Product(1, 'Product 10', 'Categoey 1', 'Descreption 10', 900),
  ];
